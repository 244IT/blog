...
#### 4.1.修订 Function.prototype.toString()
...
```js
console.log(2 ** 53) // es7 幂运算符：9007199254740992
...
### 07.空值合并运算符（Nullish coalescing Operator）
...
console.log(a)
```
>>>>>>> 7ccb8db7da07ea768b894cd244a53e8d7a6c881e
